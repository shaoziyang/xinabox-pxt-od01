...
namespace OD01 {
     ...
     * show text in OLED
     */
    //% blockId="OLED12864_I2C_SHOWSTRING" block="show string text %s|at x %x|y %y|color %color"
    //% s.defl='Hello'
    //% x.max=127 x.min=0 x.defl=0
    //% y.max=7 y.min=0 y.defl=0
    //% color.max=1 color.min=0 color.defl=1
     ...
     */
    //% blockId="OLED12864_I2C_NUMBER" block="show Number %num|at x %x|y %y|color %color"
    //% num.defl=100
    //% x.max=127 x.min=0 x.defl=0
    //% y.max=7 y.min=0 y.defl=0
    //% color.max=1 color.min=0 color.defl=1
